...
public class SsoSessionFailFilter implements Filter {
    ...
    Logger logger = Logger.getLogger(SsoSessionFailFilter.class);
    ...
    public void doFilter(
        ...
        if (isNeedFilter) {
            ...
            logger.info("ssoLoginFlag:" + ssoLoginFlag);
