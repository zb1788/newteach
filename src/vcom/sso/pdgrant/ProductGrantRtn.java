...
public class ProductGrantRtn implements Serializable {
    ...
    private ArrayList<String> appNumbersNoGrant;////δ��Ȩ��Ӧ��ģ��ʶ�����б�
    private LinkedHashMap<String, String> appIdNameMap;//ģ��ID�����ƶ��ձ�
    private LinkedHashMap<String, String> appIdNumberMap;//ģ��ID��Ӧ��ģ��ʶ������ձ�
