...
<head>
    ...
    <title></title>
    <script type="text/javascript" src="login/js/jquery172min.js"></script>
    <script type="text/javascript" src="login/js/qrcode.js"></script>
    <style>
        * {
            padding: 0;
            margin: 0;
...
<script>
    ...
    function makeQcode() {
        ...
        var url = "http://" + QueryString("sso") + ":" + port;
    ...
    function searchRel() {
        ...
        ajaxJson(url, data, "utf-8", function (rdata) {
            ...
            var myjson = eval(rdata);
            if (myjson.flag == "2") {
                var ssoUrl = "http://" + QueryString("sso") + "/sso/verifyAuthInfo?appFlg=PLS&loginUsertype=teacher&key=" + uuid;
