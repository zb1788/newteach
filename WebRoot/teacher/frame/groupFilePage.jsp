...
<%
    ...
    //TeacherInfo teacherinfo=(TeacherInfo)request.getSession().getAttribute("steacher");
...
<div class="mainContent" style="width: 760px;">
    <div class="curPos"><img src="<%=path%>/teacher/images/icon_pos.gif" width="16" height="16"/>&nbsp;当前位置：群组资源</div>
    <div class="mainCon" style="width: 760px;">
        <div class="bgTop"></div>
