...
function downGetXmlInfo(xml) {
    var rArray = new Array();
    var reg = /<file\s{1,4}path=([^\s]+)?\s{1,3}filepath=([^\s]+)?.{1,5}\/>/ig;//�ϸ�ƥ�䣬��Ȼ?��ֱ�Ӱ�����ƥ����
    var __path = null;
    while ((__path = reg.exec(xml)) != null) {
        var reg2 = /\spath=([^\s]+)?\"/ig;
        var reg3 = /\sfilepath=([^\s]+)?\"/ig;//ƥ��ո�filepath=��ʼ�ķǿ��ַ���,����playXml.do������ǰû�ո�����Ҫ��\"��
        var fpath = reg2.exec(__path[0]);
        var fname = reg3.exec(__path[0]);
        fpath = fpath[0].substring(7, fpath[0].length - 1);
        fname = fname[0].substring(11, fname[0].length - 1);
        rArray.push({"path": fpath, "name": fname});
//prompt("��ȡ�ļ���ַ",fpath);
//alert(fname);
        fpath = null;
        reg2 = null;
...
function teacherfiledownload(ids, type) {
    ...
    var url = transferProtocol_web + _config["PLS"] + "/teacherfile/nplayfile.do?ids=" + ids + "&virtualDirectory=" + virtualDirectory + "&teachernumber=" + teachernumber + "&teacherjyjg=" + teacherjyjg + "&parentfcode=" + _fileUtil.currParentFcode + "&areaCode=" + areaCode;
    try {
...
function playrecommendfile(ids, type) {
    ...
    __openfile.innerHTML = "���ڼ�����Դ,���Ժ�....";
    upload.style.left = document.documentElement.clientWidth / 2 - 330
    var url = transferProtocol_web + _config["PLS"] + "/teacherfile/nplayfile.do?ids=" + ids + "&areaCode=" + areaCode + "&teachernumber=" + teachernumber;
    filedowntype = 2;
    try {
        ocx.GetXmlFromUrl(url);
    } catch (e) {
...
//ocx�ص�ת�봦��
function callbackGetXmlFinish(strXML) {
    //alert(strXML);
    /*if(strXML=="��ȡxmlʧ��"){

     }*/
    if (filedowntype == 1) {//�����ļ����أ�����������doc��pdf�ȣ�
//alert("OnXmlFinish2");
        OnXmlFinish2(strXML);
    } else if (filedowntype == 2) {//��ʦ�ļ�����Դ����
//alert("OnXmlFinishX");
        OnXmlFinishX(strXML);
    } else if (filedowntype == 3) {
//alert("OnXmlFinish3");
        OnXmlFinish3(strXML);
    } else if (filedowntype == 4) {
//alert("OnXmlFinish3");
        //PlayDZJCSwf(strXML);
        var farr = downGetXmlInfo(strXML);
        for (var i = 0; i < farr.length; i++) {
            if (farr[i].path.indexOf("data.xml") > -1) {
                var flashh = 762;
                var flashw = 1016;
                var mtop = 0;
                ...
                var dzjccode = '<div style="height:' + flashh + 'px;width:' + flashw + 'px;text-align:center;margin-top:' + mtop + 'px;margin-left:auto;margin-right:auto;" ><object><embed src="' + transferProtocol_web + _config["PLS"] + '/newteach/flash/dzjc.swf" wmode="transparent"  allowFullScreenInteractive="true" allowFullScreen="true" quality="high" width="' + flashw + '" height="' + flashh + '" align="L" scale="noborder" flashvars="mainXmlUrl=';
                ...
                var ypskurl = transferProtocol_web + _config["PLS"] + '/teacherfile/getfilelist.do?teachernumber=' + teachernumber + '&pageindex=1&pagesize=200&noforder=2&place=4&kscode=' + kjsk.currentKsid + '&xmlFlag=1&t=' + new Date().getMilliseconds();
                dzjccode = dzjccode + encodeURIComponent(farr[i].path) + '&show=1&preferenceUrl=' + encodeURIComponent(yxurl) + '&shouKeUrl=' + encodeURIComponent(ypskurl);
...
function openfiledirect() {
    try {
        ...
        if (window.confirm("���ļ��ؼ������������������ذ�װ!")) {
            window.location.href = transferProtocol_web + _config["PLS"] + '/downloadplay.exe'
        }
    }
}
...
function teacherfileplay(ids, type, beike) {
    ...
    if (checkfiletype == 1) {
        ...
        else player.playRes(ids, '-2', 'jpg', 2, 'ͼƬ����');
        return;
    }
    try {
        TB_show('test', 300, 650);
    ...
    __beike = beike;
    __openfile.innerHTML = "���ڼ�����Դ,���Ժ�....";
    var url = transferProtocol_web + _config["PLS"] + "/teacherfile/playfile.do?ids=" + ids + "&virtualDirectory=" + virtualDirectory + "&teachernumber=" + teachernumber + "&teacherjyjg=" + teacherjyjg + "&parentfcode=" + _fileUtil.currParentFcode;
    try {
        //upload.style.left=document.documentElement.clientWidth/2-330;
        /*
         try{//�ж��Ƿ���Ҫ������������ʾ
...
function insertocx(type) {
    ...
    if (type == 1) {
        uploadlist.outerHTML = "<div id=\"uploadlist\"><table width=\"100%\" border=\"0\" bgcolor=\"#8AA9BE\"><tr><td width=\"9%\" align=\"right\"><img src=\"" + transferProtocol_web + _config["PLS"] + "/teacher/images/bg-2.jpg\" width=\"62\" height=\"63\" /></td><td width=\"91%\" height=\"50\" style=\"font-size:12px; color:#FFF\">������ؿؼ�û�а�װ�����Ѿ����������û���Զ�����������ϵ����Ա��</td></tr></table></div>";
    } else if (type == 3) {
        uploadlist.outerHTML = "<div id=\"uploadlist\"><table width=\"100%\" border=\"0\" bgcolor=\"#8AA9BE\"><tr><td width=\"9%\" rowspan=\"2\" align=\"right\"><img src=\"" + transferProtocol_web + _config["PLS"] + "/teacher/images/bg-2.jpg\" width=\"62\" height=\"63\" /></td><td width=\"91%\" height=\"50\" style=\"font-size:12px; color:#FFF\">������ؿؼ�û�а�װ������ҳ���·���ϵͳ��ʾ����װ������IE�Լ�IE�ں˵�������а�װʹ�á�</td></tr><tr><td height=\"43\"><input type=\"button\" value=\"���������ֹ���װ����װ�������´�����������ؿؼ���\" onclick=\"window.location.href='" + transferProtocol_web + _config["PLS"] + "vcomueduplayer.exe'\"/></td></tr></table></div>";
    } else if (type == 0) {
        uploadlist.outerHTML = "<div id=\"uploadlist\"><table width=\"100%\" border=\"0\" bgcolor=\"#8AA9BE\"><tr><td width=\"9%\" rowspan=\"2\" align=\"right\"><img src=\"" + transferProtocol_web + _config["PLS"] + "/teacher/images/bg-2.jpg\" width=\"62\" height=\"63\" /></td><td width=\"91%\" height=\"50\" style=\"font-size:12px; color:#FFF\">������ؿؼ��Ѿ�����������ҳ���·���ϵͳ��ʾ����װ������IE�Լ�IE�ں˵�������а�װʹ�á�</td></tr><tr><td height=\"43\"><input type=\"button\" value=\"���������ֹ���װ!��װ�������´������!\" onclick=\"window.location.href='" + transferProtocol_web + _config["PLS"] + "vcomueduplayer.exe'\"/></td></tr></table></div>";
    } else if (type == 4) {
        uploadlist.outerHTML = "<div id=\"uploadlist\"><table width=\"100%\" border=\"0\" bgcolor=\"#8AA9BE\"><tr><td width=\"9%\" rowspan=\"2\" align=\"right\"><img src=\"" + transferProtocol_web + _config["PLS"] + "/teacher/images/bg-2.jpg\" width=\"62\" height=\"63\" /></td><td width=\"91%\" height=\"50\" style=\"font-size:12px; color:#FFF\">����ϴ��ؼ�û�а�װ������ҳ���·���ϵͳ��ʾ����װ������IE�Լ�IE�ں˵�������а�װʹ�á�</td></tr><tr><td height=\"43\"><input type=\"button\" value=\"���������ֹ���װ!��װ�������´������!\" onclick=\"window.location.href='" + transferProtocol_web + _config["PLS"] + "vcomueduplayer.exe'\"/></td></tr></table></div>";
    } else if (type == 5) {
        uploadlist.outerHTML = "<div id=\"uploadlist\"><table width=\"100%\" border=\"0\" bgcolor=\"#8AA9BE\"><tr><td width=\"9%\" rowspan=\"2\" align=\"right\"><img src=\"" + transferProtocol_web + _config["PLS"] + "/teacher/images/bg-2.jpg\" width=\"62\" height=\"63\" /></td><td width=\"91%\" height=\"50\" style=\"font-size:12px; color:#FFF\">����ϴ��ؼ��Ѿ�����������ҳ���·���ϵͳ��ʾ����װ������IE�Լ�IE�ں˵�������а�װʹ�á�</td></tr><tr><td height=\"43\"><input type=\"button\" value=\"���������ֹ���װ!��װ�������´������!\" onclick=\"window.location.href='" + transferProtocol_web + _config["PLS"] + "vcomueduplayer.exe'\"/></td></tr></table></div>";
    } else {
        uploadlist.outerHTML = "<div id=\"uploadlist\"><table width=\"100%\" border=\"0\" bgcolor=\"#8AA9BE\"><tr><td width=\"9%\" rowspan=\"2\" align=\"right\"><img src=\"" + transferProtocol_web + _config["PLS"] + "/teacher/images/bg-2.jpg\" width=\"62\" height=\"63\" /></td><td width=\"91%\" height=\"50\" style=\"font-size:12px; color:#FFF\">������ؿؼ�û�а�װ������ҳ���Ϸ���ϵͳ��ʾ����װ������IE�Լ�IE�ں˵�������а�װʹ�á�</td></tr><tr><td height=\"43\"><input type=\"button\" value=\"���������ֹ���װ����װ�������´�����������ؿؼ���\" onclick=\"window.location.href='" + transferProtocol_web + _config["PLS"] + "vcomueduplayer.exe'\"/></td></tr></table></div>";
    }
...
function OnXmlFinish3(xml) {//��Դ����ʹ��
    ...
    //CHL�޸���20150128,dom�ȶ���ȡ
    var farr = downGetXmlInfo(xml);
    for (var i = 0; i < farr.length; i++) {
        filepath.push(farr[i].name);
        fileurl.push(farr[i].path);
    }
    if (fileurl.length > 0 && fileurl.length == filepath.length) {
        ...
        for (var i = 0; i < fileurl.length; i++) {
            ...
            table = table + '<table width="100%" border="0" cellspacing="0" cellpadding="0" class="upload">'
                ...
                + '<td valign="bottom" style="font-size: 12px;padding-bottom: 5px;" style="width:10px;"><img src="' + transferProtocol_web + _config["PLS"] + '/teacher/images/laji.gif" id="file_' + i + '_img"></td>'
    ...
    if (fileurl.length > 0 && fileurl.length == filepath.length) {
        ...
        for (var i = 0; i < fileurl.length; i++) {
            ...
            table = table + '<table width="100%" border="0" cellspacing="0" cellpadding="0" class="upload">'
                ...
                + '</td>'
                // +'<td class="kd2">'+size.toFixed(2)+'M</td>'
                + '<td valign="bottom" style="font-size: 12px;padding-bottom: 5px;width:15px;"><img src="' + transferProtocol_web + _config["PLS"] + '/teacher/images/laji.gif" id="file_' + i + '_img"></td>'
...
function OnXmlFinish2(xml) {//������Դ���ʹ��
    ...
    if (fileurl.length > 0 && fileurl.length == filepath.length) {
        ...
        var table = '<table width="100%" border="0" cellspacing="0" cellpadding="0" class="upload" id="' + this.fileProgressID + '">'
            ...
            + '<td style="padding-right: 15px;"><img src="' + transferProtocol_web + _config["PLS"] + '/teacher/images/laji.gif" id="file_0_img"></td>'
            + '</tr>'
            + '</table> ';
        var listend = '</div>';
        var liststart = '<div>';
...
function updatePos3(pos, speed) {
    try {
        ...
        if (pos != 100) {
            ...
            document.getElementById(currentfile.id + "_img").src = transferProtocol_web + _config["PLS"] + "/teacher/images/success.gif";
...
//alert("����״̬��"+ret);
    switch (ret) {
        case -1:
            setTimeout(function () {
                __openfile.innerHTML = "<font style=\"color: green;\">����ʧ�ܣ������ļ������ڻ��߼���ʧ��....</font><a href='javascript:' onclick=\"window.open('" + transferProtocol_web + _config["PLS"] + "/teacher/frame/help.htm')\">����</a>";
            }, 3000);
...
function updateState(state, errMsg) {
    switch (state) {
        ...
        case -1:
            ...
            try {
                document.getElementById(currentfile.id + "_sta").innerHTML = "���س���:" + errMsg + "&nbsp;&nbsp;&nbsp;<a href='javascript:' onclick=\"window.open('" + transferProtocol_web + _config["PLS"] + "/teacher/frame/help.htm')\">����</a>";
            } catch (e) {
                if (__openfile)
