...
SimpleHotkey.prototype.hotKey = function () {
    ...
    if (event.ctrlKey && event.shiftKey && '57' == event.keyCode) {//��һҳ
...
�� /*******��USB end****/
    ...
    if (event.ctrlKey && event.shiftKey && '56' == event.keyCode) {//��һҳ 
        location.href = _common.getCurrServerPath() + '/newteach/index.html';
    }
����  /*******��¼  end****/

    /*******����ҳbegin CTRL+SHIFT+H****/
    if (event.ctrlKey && event.shiftKey && '72' == event.keyCode) {//��һҳ 
        location.href = _common.getCurrServerPath() + '/newteach/index.do';
        //location.href='<%=path%>/teach/index.do';
    }
����  /*******����ҳ end****/
    //��ҳ
...
SimpleHotkey.prototype.pageDownOrUp = function (keyCode) {
    ...
    if (!_mask.isVisible()) {//δ�������ֲ�
        ...
        if (8 == _pm.getActMainPage())
            obj = new ExamSpecialContentObj();
