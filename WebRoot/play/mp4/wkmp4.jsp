...
/*String flist=(String)request.getParameter("flist");
...
//	document.getElementById("VCOMPlayer").height=playdiv.style.height;
    ...
    function playRes(data) {
        ...
        _filename.innerHTML = data[0].file_name;

        var playversion = "<%=versionpath%>";
        delayInit(_url);
    }

    function delayInit(_url) {
        playerObj.URL = _url;
        ...
        playerObj.movieName = flist[0].file_name;
